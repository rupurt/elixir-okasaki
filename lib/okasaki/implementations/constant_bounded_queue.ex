defmodule Okasaki.Implementations.ConstantBoundedQueue do
  @moduledoc """
  Okasaki.ConstantBoundedQueue
  is a Purely Functional Queue of a maximum size that performs both insertion and removal at guaranteed O(1) (constant) time.
  """
